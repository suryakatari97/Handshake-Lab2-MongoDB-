...
import CompanyNavber from "../company/CompanyNavbar";
...
class CompanyProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      profile.company_name = !isFieldEmpty(profile.company_name)
        ? profile.company_name
        : "";
      profile.location = !isFieldEmpty(profile.location)
        ? profile.location
        : "";
      profile.description = !isFieldEmpty(profile.description)
        ? profile.description
        : "";
      profile.contact_info = !isFieldEmpty(profile.contact_info)
        ? profile.contact_info
        : "";
      profile.email = !isFieldEmpty(profile.email) ? profile.email : "";
      profile.profile_pic = !isFieldEmpty(profile.profile_pic)
        ? profile.profile_pic
        : "";
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-8 m-auto">
                <h1 className="display-4 text-center">Edit Company Profile</h1>
